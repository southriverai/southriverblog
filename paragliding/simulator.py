...
from paragliding.flight_conditions import FlightConditionDistribution
...
class Simulator:
    def __init__(
        self,
        flight_condition_distribution: FlightConditionDistribution,
    ...
    def simulate_batch(
        self, policy: FlightPolicyBase, num_simulations: int
        ...
        return ExperimentOutputBatch(list_experiment_outputs=list_experiment_outputs)
