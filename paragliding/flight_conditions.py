...
class FlightConditionDistribution:
    """
    ...
    def __init__(
        ...
        *,
        ...
        termal_net_climb_std_m_s: float = 0.5,
        ...
        self.climb_min_m_s = climb_min_m_s
        self.climb_max_m_s = climb_max_m_s
        ...
        self._termal_net_climb_std_m_s = termal_net_climb_std_m_s
    ...
    def sample(self) -> FlightConditions:
        ...
        mean_m_s = np.random.uniform(self.climb_min_m_s, self.climb_max_m_s)
        termal_net_climb_min_m_s = max(0.05, mean_m_s - 0.5)
        termal_net_climb_max_m_s = min(10.0, mean_m_s + 2.0)
        return FlightConditions(
            ...
            termal_net_climb_std_m_s=self._termal_net_climb_std_m_s,
